...
<body>
    <div class="form-container">
        <h2><b>Editar Paquete</b></h2>
        <form action="index.php?controller=paquete&action=update" method="post">
            ...
            <input type="text" name="nombre_servicio" id="nombre_servicio" value="<?php echo htmlspecialchars($paquete['nombre_servicio']); ?>" required>

            <label for="monto">Monto:</label>
            <input type="number" step="0.01" name="monto" id="monto" value="<?php echo htmlspecialchars($paquete['monto']); ?>" required>
